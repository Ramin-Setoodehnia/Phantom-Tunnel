ببین این فایل جدید که بهت دادم نسخه قدیمی هست و اینم uninstall هست ان اینستال جوری درست کن هم تمام اطلاعات قدیمی رو پاک کنه هم جدید کلا هیچی از phantom رویه سرور نزاره
